...
class DataGenerator(object):
    ...
    def generate(self, input_shapes: dict, exp_dir: str, output_shapes: Optional[dict] = None):
        ...
        data_inputs = {input_name: self.__generate(input_shape) for input_name, input_shape in
                       input_shapes.items()}
        ...
        if output_shapes:
            ...
            ground_truths = {output_name: self.__generate(output_shape) for
                             output_name, output_shape in output_shapes.items()}
