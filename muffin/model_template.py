...
class ModelTemplate(object):
    class Cell(object):
        def __init__(self, topo_id: int, _type: str, node_num: int, is_input: bool = False,
    ...
    def __init__(self, randomer, template_type, cell_num, node_num_per_normal_cell,
                 node_num_per_reduction_cell, input_shape, output_shape, **kwargs):
        self.__random = randomer

        self.cells = self.__init_T1(cell_num, node_num_per_normal_cell, node_num_per_reduction_cell,
                                    input_shape, output_shape)

    def __init_T1(self, cell_num, node_num_per_normal_cell, node_num_per_reduction_cell,
                  input_shape, output_shape):
