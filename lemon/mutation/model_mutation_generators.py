...
if __name__ == '__main__':
    ...
    mutated_model = generate_model_by_model_mutation(model=origin_model,
                                                     operator=flags.mutate_op)  # ,mutate_ratio=mutate_ratio
