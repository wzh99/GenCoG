...
class LayerUtils:
    def __init__(self):
        ...
        # self.available_model_level_layers['separable_conv_1d'] = LayerUtils.separable_conv_1d           # not supported
        ...
        # self.available_model_level_layers['elu_layer'] = LayerUtils.elu_layer                           # not supported
        # self.is_input_legal['elu_layer'] = LayerUtils.elu_layer_input_legal
        # self.available_model_level_layers['thresholded_relu_layer'] = LayerUtils.thresholded_relu_layer # not supported
        ...
        # self.available_source_level_layers['activity_regularization_l1'] = LayerUtils.activity_regularization_l1    # not supported
        # self.is_input_legal['activity_regularization_l1'] = LayerUtils.activity_regularization_input_legal
        # self.available_source_level_layers['activity_regularization_l2'] = LayerUtils.activity_regularization_l1    # not supported
    ...
    def is_layer_in_weight_change_white_list(self, layer):
        import keras
        white_list = [keras.layers.Dense, keras.layers.Conv1D, keras.layers.Conv2D,
                      keras.layers.Conv3D,
                      keras.layers.DepthwiseConv2D,
                      keras.layers.Conv2DTranspose, keras.layers.Conv3DTranspose,
                      keras.layers.MaxPooling1D, keras.layers.MaxPooling2D,
    ...
    @staticmethod
    def clone(layer):
        from ..tools.utils import ModelUtils
    ...
    def conv2d_input_legal(input_shape):
        input_shape = input_shape.as_list()
        return len(input_shape) == 4 and input_shape[0] is None and input_shape[1] is not None and \
               input_shape[1] >= 3 \
...
if __name__ == '__main__':
    ...
    result = layerUtils.is_layer_in_weight_change_white_list(
        layerUtils.available_model_level_layers['dense']([None, 3]))
    print(result)
